...
if (electronPackage.version !== "40.2.1") throw new Error(`Native addon build is pinned to Electron 40.2.1, found ${electronPackage.version}`);
...
const archiveUrl = "https://artifacts.electronjs.org/headers/dist/v40.2.1/node-v40.2.1-headers.tar.gz";
const archiveSha256 = "35476b9cfe8a71494e64bbad221d42f7ed1cc8c3dee7a39a1db0bd4cbac27afe";
...
if (!(await validElectron40Headers(headerRoot))) {
  if (process.env["ELECTRON_HEADERS"]) throw new Error(`Electron 40.2.1 header metadata mismatch at ${headerRoot}`);

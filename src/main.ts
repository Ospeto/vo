...
function pasteTextToFocusedField(text: string) {
  ...
  try {
    ...
    try {
      ...
      clipboard.writeBuffer("org.nspasteboard.ConcealedType", Buffer.from(""));
      clipboard.writeBuffer("org.nspasteboard.AutoGeneratedType", Buffer.from(""));
      clipboard.writeBuffer("de.nspasteboard.TransientType", Buffer.from(""));
    } catch {}

...
2. The documented lifecycle and renderer acknowledgements are enforced; toggle behavior follows Decision 2, including the single queued stop during `starting`; shutdown can be called repeatedly without throwing or leaking runtime files.
